...
tx_idx =[0,9,18,27,36,45,54,63]
# tx_idx =[20,21,22,23,40,41,42,43]
# tx_idx =[0,1,2,3,60,61,62,63]
# tx_idx =[6,9,22,25,38,41,54,57]
# tx_idx =[0,3,20,23,40,43,60,63]
SMP = 39600
val_split_rate = 0.05
test_split_rate = 0.05

data_path = '../data/new/'
data = h5py.File(data_path+'beam_rsrp_all.mat', 'r')
data = data['rsrp'][:] 

X = data[:, tx_idx,::int(BEAM_RX/USE_RX)]
y_label = np.reshape(data, [-1, 256])#(39600,256)
...
BM_RSRP_NET.load_weights('models.h5')
